(function(ns)
{
				...
				<div class="panel-body card-body">
					<div class="row">
						<div class="col-12 col-sm-10">
							<div>ID: {{ item.id }}, Codigo: {{ item.codigo }}, Sucursal: {{ item.codigo_sucursal }}</div>
							<div>Tipo: ({{ item.tipo_descripcion }}) {{ item.nombre }}</div>
							<div></div>
	...
	Object.assign(SBFramework.AppComponents, {'siat-puntos-venta': ns.ComPuntosVenta});
