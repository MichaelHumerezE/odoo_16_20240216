(function(ns)
{
	ns.ComSyncTiposPuntoVenta = {
		template: `<div id="com-sync-tipos-punto-venta">
		...
		methods: 
		{
			...
			{
				try {
					// const res = await this.$parent.service.obtenerTiposPuntoVenta();
					const res = await this.$parent.service.obtenerTiposPuntoVentaPiloto(this.codigo_sucursal, this.codigo_puntoVenta);
