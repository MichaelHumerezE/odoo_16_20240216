(function(ns)
{
	ns.CufdListing = {
		template: `<div id="com-siat-cufd-listing" class="container-fluid">
			...
			<div class="panel car border shadow" v-for="(item, index) in items">
					...
					<div class="container-fluid">
						<div class="row">
							...
							<div class="col-12 col-sm-2">
								<div><b>Fecha creacion:</b> {{ item.fecha_creacion }}</div>
	...
	Object.assign(SBFramework.AppComponents, {'siat-cufd-listing': ns.CufdListing});
